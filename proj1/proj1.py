...
ip_1 = pd.read_excel("/content/drive/MyDrive/seating arrangement.xlsx/2024 Python Project Part 1. Group of two.xlsx",  sheet_name="ip_1", header=1)
ip_2 = pd.read_excel("/content/drive/MyDrive/seating arrangement.xlsx/2024 Python Project Part 1. Group of two.xlsx" , sheet_name="ip_2", header=1)
ip_3 = pd.read_excel("/content/drive/MyDrive/seating arrangement.xlsx/2024 Python Project Part 1. Group of two.xlsx" , sheet_name="ip_3")
ip_4 = pd.read_excel("/content/drive/MyDrive/seating arrangement.xlsx/2024 Python Project Part 1. Group of two.xlsx" , sheet_name="ip_4")
